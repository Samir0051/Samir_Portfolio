...
const featuredProject = {
  ...
  blurb:
    "LLM infrastructure for developing instantaneous research taxonomies given a set of research papers",
...
const timelineProjects = [
  ...
  },
  {
    ...
    description:
      "Developed LLM infrastructure for generating scalable bioinformatic research taxonomies",
    url: "https://github.com/Samir0051/building_research_taxonomy",
  ...
  },
  {
    ...
    description:
      "Developed a custom filesystem module in Linux alongside a team of two other students",
    url: "https://www.dropbox.com/scl/fo/7lifwa67zt8y0etqhz9wm/ACVR4efRu0FQY6EAgx5WJ2E?rlkey=uqnzbnmw8odrq9dxy3i15zbxd&st=6hlzgpcf&dl=0",
    languages: ["C"],
    category: "Systems Programming",
    status: "Complete",
    impact:
      "Low-level systems understanding for file systems and their creation",
  },
  {
    year: "2025",
    title: "Custom Linux Scheduler",
    description:
      "Developed a custom simple round-robin scheduler in Linux alongside a team of two other students",
    languages: ["C"],
    url: "https://www.dropbox.com/scl/fo/mxniaqr1w7ysnwyt6t9bx/AHj_z48EfDI4rWexGOCnECA?rlkey=3l6coepnmwzcxaz3auiqywuda&st=gxealtoo&dl=0",
    category: "Systems Programming",
    status: "Complete",
    impact:
      "Understanding of scheduling systems in Linux and their integration",
  },
  {
    year: "2024",
    title: "Conformer Model Sequential Batching (Amazon SDE Internship)",
    description:
      "Integrated sequential batching to a Conformer Model within a pre-existing LLM pipeline",
  ...
  },
  {
    ...
    description:
      "Developed a mock-website alongside a cirriculum to teach students",
    url: "https://github.com/Samir0051/webDev",
  ...
  },
  {
    ...
    description:
      "Develop internal tooling onto Alexa's model to showcase hypothesis predictions to what it believes the user says",
  ...
  },
  {
    ...
    url: "https://github.com/Samir0051/mywebsite",
  ...
  },
  {
    ...
    description:
      "Train a U-Net model on a dataset for single-cell segmentation which was presented to Columbia's Biomedical Engineering department!",
  ...
  },
  {
    ...
    title: "Lucky Bird",
    description:
      "Alongside a team developed a Lucky Bird original game that was presented at an expo at Columbia!",
  ...
  },
  {
    ...
    title: "Brick Breaker",
    description:
      "Personal game project developed to emulate the classic brick breaker game in Java",
    url: "https://github.com/Samir0051/BrickBreaker",
...
const StatusBadge = ({ status }) => {
  ...
  return (
    <span
      className={`inline-block px-2 py-1 text-xs rounded-full bg-gradient-to-r ${
        colors[status] || "from-gray-400 to-gray-600"
...
export default function Projects() {
  ...
  const categories = [
    "All",
    ...new Set(timelineProjects.map((p) => p.category)),
  ];
              ...
              >
                ...
                <div className="p-8 bg-gradient-to-br from-gray-800 to-gray-900">
                  ...
                  <div className="grid grid-cols-3 gap-4 pt-4 border-t border-gray-700">
                    {Object.entries(featuredProject.stats).map(
                      ([key, value]) => (
