...
export default function DiscussionBoard() {
  ...
  async function handleSubmit(e) {
    ...
    if (error) {
      ...
      // Remove new post highlight after 3 seconds
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-emerald-50 to-cyan-50 dark:from-neutral-900 dark:via-neutral-800 dark:to-emerald-900 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-xl text-gray-600 dark:text-gray-400">Loading discussions...</p>
        </div>
      </div>
    )
  }
  ...
  return (
    <div className={`min-h-screen bg-gradient-to-br from-slate-50 via-emerald-50 to-cyan-50 dark:from-neutral-900 dark:via-neutral-800 dark:to-emerald-900 text-gray-900 dark:text-white transition-all duration-500 relative overflow-hidden`}>
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        {Array.from({ length: 12 }, (_, i) => (
          <div
            ...
            style={{
              background: `linear-gradient(45deg, ${['#10b981', '#06b6d4', '#3b82f6', '#8b5cf6'][i % 4]}, transparent)`,
      ...
      <div className="relative p-8 max-w-6xl mx-auto">
        ...
        <div className="relative mb-12 text-center">
          ...
          <div className="relative py-8 px-6">
            <h2 className={`font-extrabold mb-4 text-3xl sm:text-4xl md:text-5xl lg:text-6xl
        ...
        <div className="relative mb-12">
          <div className={`absolute inset-0 bg-white/80 dark:bg-white/10 backdrop-blur-xl rounded-2xl shadow-xl border border-white/30 transition-all duration-500 
            ${showCelebration ? 'shadow-emerald-500/50 shadow-2xl scale-105' : 'hover:shadow-2xl hover:scale-[1.02]'}`}></div>
            ...
            <div className="flex justify-center">
              <button
                ...
                className={`bg-gradient-to-r from-emerald-600 to-emerald-500 hover:from-emerald-500 hover:to-emerald-400 
                  ...
                  ${isSubmitting ? 'animate-pulse' : ''} transform active:scale-95`}
              >
                {isSubmitting ? (
          ...
          {posts.map((post, idx) => (
            <div
              ...
              className={`group relative p-6 rounded-2xl shadow-lg cursor-pointer
                ...
                ${newPostId === post.id ? 'ring-4 ring-emerald-400 animate-pulse scale-105' : ''}
            ...
            >
              ...
              <div className={`absolute inset-0 rounded-2xl bg-gradient-to-br from-emerald-400/20 to-emerald-600/20 
                opacity-0 group-hover:opacity-100 transition-all duration-500 
                ${hoveredPost === post.id ? 'animate-pulse' : ''}`}></div>
              
              {/* Content */}
              <div className="relative z-10">
                <p className={`text-gray-900 dark:text-white whitespace-pre-wrap font-semibold mb-4 text-lg leading-relaxed
                  transition-all duration-300 ${hoveredPost === post.id ? 'scale-105' : ''}`}>
                  {post.message}
                </p>
                
                <div className={`flex items-center text-sm font-bold text-gray-600 dark:text-white/70 
                  transition-all duration-300 ${hoveredPost === post.id ? 'translate-x-2' : ''}`}>
        ...
        {posts.length === 0 && !isLoading && (
          <div className="text-center py-16">
            ...
            <p className="text-lg text-gray-600 dark:text-gray-400">
              Be the first to share your thoughts and get the discussion rolling.
            </p>
          </div>
        )}
          ...
          <div className="mt-8 text-center">
            <div className="inline-flex items-center bg-white/60 dark:bg-white/10 backdrop-blur-lg rounded-full px-6 py-3 border border-white/30">
              ...
              <span className="text-lg font-semibold text-gray-700 dark:text-gray-300">
                {posts.length} {posts.length === 1 ? 'Message' : 'Messages'} Shared
              </span>
            </div>
          </div>
        )}
